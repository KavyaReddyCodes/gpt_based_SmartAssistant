...
#functoin to use chatgpt as client
def Reply(question):
    completion = client.chat.completions.create(
        ...
        max_tokens=200 #length of a word limit in the output
    )
    answer = completion.choices[0].message.content
    return answer 
           
            # For a very simple bot
"""
            question = "What is coice assistant?"
            ans = Reply(question)
            print(ans)
...
speak("Hello, How may i help you?") #First thing that bot tells
